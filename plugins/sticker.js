...
ptt: true, contextInfo: {
        externalAdReply: { showAdAttribution: true, title: ucapan, body: 'Sebentar Yah Kak Lagi Di Proses', sourceUrl: 'https://www.tiktok.com/', thumbnail: await (await fetch('https://i.postimg.cc/XJwXB2QW/fek.jpg')).buffer(),}} 
     })
  let stiker = false
  let wsf = false
  try {
