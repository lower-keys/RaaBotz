 ...
 *Powered By @${'6288269131506'.split('@')[0]}*`
 ...
     const ultah = new Date('October 16 2022 23:59:59')
 ...
     }) 
     if (teks == '404') {
 	let cute = `${pickRandom(['https://i.postimg.cc/8zCXVkyY/ce6ffeea35742410166301aede74af0d.jpg', 'https://i.postimg.cc/g01ZNptQ/2581c5803ef77dfad121830c07873129.jpg', 'https://i.postimg.cc/GmQBvddb/3db17e4c76671353a6896ff4ad6b5eb8.jpg'])}` 
 	let ori = `Hi , @${m.sender.split`@`[0]}
*Andromeda Here 🙌*
`
...
return conn.send3ButtonLoc(m.chat, await conn.resize(pickRandom(global.takina), 300, 300), ori, `Kalo Ga Support Button Klik ${_p}simplemenu`, 'COMMAND', '.simplemenu', 'DONATION', '.donasi', 'RENT BOT', '.sewa', m)
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Wa Owner'])}`, sourceUrl: 'wa.me/6288269131506', thumbnail: await (await fetch('https://telegra.ph/file/dffdaf0e8d59ad104e526.jpg')).buffer(),}} 
     })
} catch (e) { 
